...
На пилотном этапе модель разворачивается в продуктовом контуре Jira и используется реальными сотрудниками для обработки части заявок.
...
3. **Объём и план выполнения**  
   ...
   - **Объём теста**: в среднем в сутки создаётся ~300 заявок в поддержку, ожидаем не менее 3000 запросов для проверки качества. 
